...
from gym_pybullet_drones.rma.on_policy_algorithm import OnPolicyAlgorithm
from gym_pybullet_drones.rma.rma_util import plot3d_traj, traj_rollout


class RMA_phase1(OnPolicyAlgorithm):
    """
    ...
    def __init__(
        ...
        super(RMA_phase1, self).__init__(
            policy,
            env,
