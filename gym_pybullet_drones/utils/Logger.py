...
class Logger(object):
    ...
    def __init__(self,
                 ...
                 duration_sec: int=0,
                 colab: bool=False,
                 drone_cfg: list = [DroneEntity(drone_model=DroneModel.CF2X)],
                 hetero_multidrone: bool=False
                 ):
        ...
        #!!! Define the Drone Cfg and variable hetero_multidrone
        if hetero_multidrone:
